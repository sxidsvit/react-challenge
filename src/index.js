...
const UserCard = ({ author: { firstName, lastName }, techs }) => {
  const styles = {
    userCardBorder: {
      border: "1px solid #2ACFCF",
      borderRadius: "20px",
...
const Subscribe = ({ styles: { subscribeBorder, subscribeH1, subscribeButton, subscribeInput } }) => {
  return (
    <div className="d-flex flex-column justify-content-center align-items-center"
      style={subscribeBorder} >
      <h1 style={subscribeH1}>SUBSCRIBE</h1>
      <p>Sign up with your email address to receive news and updates</p>
      <div className="d-flex justify-content-around " >
        <input style={subscribeInput} type="text" placeholder="First name" />
        <input style={subscribeInput} type="text" placeholder="Lirst name" />
        <input style={subscribeInput} type="text" placeholder="Email" />
      </div>
